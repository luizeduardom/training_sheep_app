...
class FichaIntermediarioPage extends StatefulWidget {
  @override
  _FichaIntermediarioPageState createState() => _FichaIntermediarioPageState();
}

class _FichaIntermediarioPageState extends State<FichaIntermediarioPage> {
  ...
  void initState(){
    ...
    _treinosQuery = FirebaseFirestore.instance
        .collection('ficha')
        .where('nivel', isEqualTo: "Intermediário")
        .snapshots();
  }
