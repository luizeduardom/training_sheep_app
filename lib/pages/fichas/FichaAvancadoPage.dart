...
class FichaAvancadoPage extends StatefulWidget {
  @override
  _FichaAvancadoPageState createState() => _FichaAvancadoPageState();
}

class _FichaAvancadoPageState extends State<FichaAvancadoPage> {
  ...
  void initState(){
    ...
    _treinosQuery = FirebaseFirestore.instance
        .collection('ficha')
        .where('nivel', isEqualTo: "Avançado")
        .snapshots();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: Icon(Icons.arrow_back_ios_new_sharp, color: Colors.black87),
                      ...
                      child: Row(
                        children: [
                          IconButton(
                            ...
                            icon: const Icon(Icons.star_border, color: Colors.redAccent,),
                          ),
                        ],
                      ),
                    ),
